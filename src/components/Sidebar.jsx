...
function Sidebar() {
  return (
    <div className="w-[235px]">
      <div className="h-[145px] flex flex-col items-center justify-center ">
        <div className="flex justify-center w-full ">
          <p className="text-[#C5A8DE]  text-2xl">Do</p>
          <p className="text-[#484848]   text-2xl">easily</p>
        </div>
        <p className="text-[#484848] text-center font-[30] leading-[normal] text-sm">
          Business Made Easy
        </p>{" "}
      </div>
      <div className="flex flex-col text-center mt-10">
        <div className="ml-[22px] flex items-center gap-1">
          ...
          <p className=" text-[#484848] text-lg not-italic font-[590] leading-[normal]">
            Parties
          </p>
        ...
        <div className="w-full  justify-center  gap-y-1 mt-4">
          <p className="w-full bg-[#484848] text-white">Karigar</p>
          <p className="text-[#5A5A5A]">Bullion </p>
          <p className="text-[#5A5A5A]">Supplier</p>
          <p className="text-[#5A5A5A]">Customer</p>
        </div>
      </div>
    </div>
  );
